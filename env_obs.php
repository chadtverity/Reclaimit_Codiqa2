...
reg_date TIMESTAMP
	...
	if(!@mail($email,"Environment Observation",$message)) die(json_encode(array('type'=>'message', 'text' =>'Error sending email' )));
